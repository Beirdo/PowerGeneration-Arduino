...
byte start_address = 0;       // lower addresses are reserved to prevent conflicts with other protocols
byte end_address = 0x7F;       // higher addresses unlock other modes, like 10-bit addressing
